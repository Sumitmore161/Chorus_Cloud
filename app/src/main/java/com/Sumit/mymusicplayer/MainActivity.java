package com.Sumit.mymusicplayer;
...
import com.Sumit.mymusicplayer.databinding.ActivityMainBinding;
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                        ...
                        if (myAllSongs.isEmpty()) {
                            ...
                            binding.recyclerView.addItemDecoration(new DividerItemDecoration(MainActivity.this, DividerItemDecoration.HORIZONTAL));
    ...
    public ArrayList<File> getSongs(File file) {
        ...
        if (songs != null) {
            for (File mySongs : songs) {
                // if my mySong is directory in itself so use getsongs on the directory itself
