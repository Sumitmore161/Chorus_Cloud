...
import com.Sumit.mymusicplayer.databinding.ActivityPlayingMusicBinding;
        ...
        thread = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    binding.TotalDuration.setText(totaltime);
                    while (currentPosition < mediaPlayer.getDuration()) {
                        ...
                        binding.CurrentDuration.setText(currenttime);\
                       // Toast.makeText(PlayingMusic.this, String.valueOf(currentPosition), Toast.LENGTH_SHORT).show();
                        sleep(1000);
//
